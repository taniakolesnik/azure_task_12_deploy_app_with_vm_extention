...
echo "git clone https://github.com/taniakolesnik/azure_task_12_deploy_app_with_vm_extention.git"
sudo git clone https://github.com/taniakolesnik/azure_task_12_deploy_app_with_vm_extention.git
